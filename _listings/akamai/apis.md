...
- name: Akamai API List Data Sources
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/uri/master/_listings/akamai/security-monitor-v1-report-packs-reportpackid-data-sources-get.md
x-common:
- type: x-base
