...
- name: Akamai API Remove a Policy
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/uri/master/_listings/akamai/config-media-security-v1-security-policyid-promotedelete-delete.md
x-common:
- type: x-base
