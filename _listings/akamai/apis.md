...
- name: Akamai API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/uri/master/_listings/akamai/security-monitor-v1-report-packs-reportpackid-data-stores-datastoreid-get.md
x-common:
- type: x-base
