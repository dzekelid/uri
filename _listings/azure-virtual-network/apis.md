...
- name: Azure Virtual Network API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/uri/master/_listings/azure-virtual-network/subscriptions-subscriptionid-providers-microsoft-network-networksecuritygroups-get.md
x-common:
