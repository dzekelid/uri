...
- name: OpenCorporates Companies  Jurisdiction Code  Company Number Data
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/uri/master/_listings/opencorporates/companies-jurisdiction-code-company-number-data-get.md
x-common:
- type: x-base
